...
import uts.sdk.modules.xTipsS.showTips;
import uts.sdk.modules.xTipsS.XTIPS_TYPE;
open class GenPagesUtsapiXtips : BasePage {
    ...
    override fun `$initMethods`() {
        this.loadAlert1 = fun() {
            showTips(XTIPS_TYPE(title = "操作成功"));
        }
        ;
        this.loadAlert2 = fun() {
            showTips(XTIPS_TYPE(iconCode = "EB79", position = "bottom", title = "操作成功", contentBgColor = "#333", titleColor = "#1fc73d", iconColor = "#1fc73d"));
        }
        ;
        this.loadAlert3 = fun() {
            showTips(XTIPS_TYPE(iconCode = "", contentBgColor = "#000000", title = "提示消息提示消息提示消息提示消息操作成功操作成功提示消息提示消息提示消息提示消息操作成功操作成功"));
        }
        ;
    }
