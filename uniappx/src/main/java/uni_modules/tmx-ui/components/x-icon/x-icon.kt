...
open class GenUniModulesTmxUiComponentsXIconXIcon : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("xIcon" to null as Element?, "refreshId" to 1, "id" to ("xIconspin" + getUid1()), "element" to null as Element?, "rotationDeg" to 0, "isLoad" to false, "isdestory" to false, "status" to "play", "tid" to 0, "xt" to xTween(), "_iconName" to computed<String>(fun(): String {
            return this.name;
        }
