...
open class GenUniModulesTmxUiComponentsXButtonXButton : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("_set_border_color" to "1px solid #00000", "_set_background_color" to "#00000", "_set_background_img" to "", "_set_font_color" to "#00000", "_set_opacity" to "1", "_isHover" to false, "boxShadow" to "0 0px 0px rgba(0,0,0,0)", "_fontWeight" to computed<String>(fun(): String {
    ...
    override fun `$initMethods`() {
        ...
        ;
        this.findParent = fun(parent: VueComponent?): VueComponent? {
            if (parent == null) {
                return null;
            }
    ...
    open lateinit var findParent: (parent: VueComponent?) -> VueComponent?;
