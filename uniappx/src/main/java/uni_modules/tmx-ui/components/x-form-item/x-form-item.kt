...
open class GenUniModulesTmxUiComponentsXFormItemXFormItem : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("id" to ("xForItem-" + getUid1()) as String, "errorText" to "请正确填写", "isError" to false, "first" to true, "tid" to 0, "_showError" to computed<Boolean>(fun(): Boolean {
