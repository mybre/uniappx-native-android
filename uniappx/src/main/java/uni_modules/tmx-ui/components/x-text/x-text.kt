...
open class GenUniModulesTmxUiComponentsXTextXText : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("text", mergeProps(utsMapOf("onClick" to _ctx.allClick, "style" to utsArrayOf(
            _ctx._styleMap,
            _ctx.___style
        ), "class" to utsArrayOf(
            _ctx.___class,
            "xTextLines"
        ), "selectable" to _ctx.selectable), _ctx.`$attrs`), utsArrayOf(
            renderSlot(_ctx.`$slots`, "default", UTSJSONObject(), fun(): UTSArray<Any> {
                return utsArrayOf(
                    if (_ctx._label == "") {
                        createElementVNode("text", mergeProps(utsMapOf("key" to 0, "onClick" to _ctx.allClick, "style" to utsArrayOf(
                            _ctx._styleMap,
                            _ctx.___style
                        ), "class" to utsArrayOf(
                            _ctx.___class,
                            "xTextLines"
                        ), "selectable" to _ctx.selectable), _ctx.`$attrs`), toDisplayString(_ctx._label), 17, utsArrayOf(
                            "onClick",
                            "selectable"
                        ));
                    } else {
            ...
            createElementVNode(Fragment, null, RenderHelpers.renderList(_ctx._texts, fun(item, index, __index, _cached): Any {
                return createElementVNode("text", mergeProps(utsMapOf("onClick" to fun(){
