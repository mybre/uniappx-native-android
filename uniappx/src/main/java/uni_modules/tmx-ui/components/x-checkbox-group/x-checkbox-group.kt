...
open class GenUniModulesTmxUiComponentsXCheckboxGroupXCheckboxGroup : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("oldvalueList" to utsArrayOf<XCHECKBOX_LISTITEM_TYPE>(), "checkvaluelist" to utsArrayOf<String>(), "tid" to 0, "isDestroy" to false, "id" to ("xCheckboxGroup-" + getUid1()), "oldvalueList_ids" to computed<UTSArray<String>>(fun(): UTSArray<String> {
    ...
    override fun `$initMethods`() {
        this.addItem = fun(t: XCheckboxComponentPublicInstance, item: CHECKBOX_ITEM_INFO, ischange: Boolean) {
            var _this = this;
    ...
    open lateinit var addItem: (t: XCheckboxComponentPublicInstance, item: CHECKBOX_ITEM_INFO, ischange: Boolean) -> Unit;
