    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesTmxUiComponentsXNavbarXNavbar) -> Any? = fun(__props): Any? {
            ...
            val _styleMap = computed(fun(): Map<String, String> {
                ...
                maps.set("height", (statusBarHeight.value + navbarHeight) + "px");
                if (isFiexd.value) {
            ...
            watchEffect(fun(){
                var barheight = statusBarHeight.value + navbarHeight;
            ...
            return fun(): Any? {
                ...
                return createElementVNode("view", null, utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "xNavbar", "style" to normalizeStyle(utsMapOf("zIndex" to _ctx.zIndex))), utsArrayOf(
                        ...
                        createElementVNode("view", utsMapOf("class" to "xNavbarContentBox"), utsArrayOf(
                            ...
                            createElementVNode("view", utsMapOf("class" to "xNavbarContent", "style" to normalizeStyle(utsMapOf("height" to (navbarHeight + "px")))), utsArrayOf(
                    ...
                    if (isTrue(_ctx.isPlace)) {
                        createElementVNode("view", utsMapOf("key" to 0, "style" to normalizeStyle(utsMapOf("height" to ((unref(statusBarHeight) + navbarHeight) + "px")))), null, 4);
                    } else {
                        createCommentVNode("v-if", true);
                    }
                ));
        ...
        ), "staticTransparent" to utsMapOf("type" to "Boolean", "default" to false)));
